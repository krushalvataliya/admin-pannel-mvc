...
class Controller_Product_Media extends Controller_Core_Action
{
	...
	function gridAction()
	{
		...
		$modelProductMedia =Ccc::getModel('Product_Media_Row');
		$results =$modelProductMedia->fetchAll($sql);
		$this->getView()->setTemplete('product/media/grid.phtml')->setData(['media' => $results]);
		$this->render();
	}
	function addAction()
	{
		$this->getView()->setTemplete('product/media/add.phtml');
		$this->render();
	}
	function insertAction()
	{
		try 
		{
			...
			$modelProductMedia =Ccc::getModel('Product_Media_Row')->setData($media);
	...
	function updateAction()
	{
		try
		{
			...
			$modeltMedia =Ccc::getModel('Product_Media');
